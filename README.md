...
Для работы в веб-интерфейсе MLFlow необходимо выполнить команду:  
```bash
mlflow ui
```  
После чего по адресу [localhost:5000](http://localhost:5000/) можно проанализировать и сравнить разные сборки модели:  
![mlflow_cmd](./readme/mlflow_cmd.png)  
![mlflow_ui](./readme/mlflow_ui.png)  
